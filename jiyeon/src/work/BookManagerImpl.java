...
/*	private final int MAX_SIZE = 100;	
	...
	@Override
	public void sell(String isbn, int quantity) throws QuantityException, ISBNNotFoundException{ //Exception묶어버리기
...
/*		for(Book b : books) {
		...
		if(diff < 0) throw new QuantityException();
		book.setQuantity(diff);
